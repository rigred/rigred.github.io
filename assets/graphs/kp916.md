...
%% ───── Style palette: neutral mid-tones (light & dark friendly) ─────
%% Socket outline
classDef socket fill:#dbeafe,stroke:#1e3a8a,stroke-width:2px
%% Coherent fabric – die 0
classDef fabric fill:#dcfce7,stroke:#166534,stroke-width:1px
%% Coherent fabric – die 1 (dashed)
classDef fabricAlt fill:#fef9c3,stroke:#ca8a04,stroke-width:1px,stroke-dasharray:5
%% Core clusters
classDef cluster fill:#fce7f3,stroke:#9d174d,stroke-width:1px
%% Shared L2 caches
classDef l2 fill:#e0e7ff,stroke:#4338ca,stroke-width:1px
%% LLC slices
classDef llc fill:#fee2e2,stroke:#b91c1c,stroke-width:1px
%% HCCS controller fabric
classDef hccs fill:#e0f2fe,stroke:#0369a1,stroke-width:1px
%% High-speed links (die-to-die / socket-to-socket)
classDef link fill:#cffafe,stroke:#0e7490,stroke-width:1px
%% IO blocks (PCIe, 10 GbE, peripheral ctrl)
classDef io fill:#ede9fe,stroke:#6d28d9,stroke-width:1px
%% DDR PHYs
classDef mem fill:#f3e8ff,stroke:#7e22ce,stroke-width:1px
%% CCN routers
classDef router fill:#e5e7eb,stroke:#374151,stroke-width:1px
%% Individual A72 cores (slightly transparent white)
classDef core fill:#ffffff,stroke:#4b5563,stroke-width:1px,fill-opacity:0.85
