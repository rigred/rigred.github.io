...
excerpt: "This project is an open-source attempt to re-create and improve upon a classic piece of hardware, the 128MB 72-pin EDO/FPM RAM module. The goal is to produce a more reliable and affordable alternative to the expensive, flawed designs currently available, addressing issues like poor power regulation and limited component support."
type: post
header:
...
![Side A of SIMMBA Revision A1 (January 2022)]({{ site.baseurl }}/assets/2022/03/SIMMBA-72-SideA.png)  

![Side B of SIMMBA Revision A1 (January 2022)]({{ site.baseurl }}/assets/2022/03/SIMMBA-72_SideB.png)  
